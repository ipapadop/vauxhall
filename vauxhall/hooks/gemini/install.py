...
def _is_vauxhall_handler(handler: object) -> bool:
    ...
    Args:
        handler: The handler entry from the Gemini settings file.

    Returns:
        Whether the handler was written by this installer, including the legacy
        script form earlier versions wrote.
    """
